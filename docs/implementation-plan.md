...
状態: 段階3 ほぼ完了（実機が ws_connected、Cloudflare に device_connected 記録）。段階4 をデプロイ済み、実機での 202 確認待ち
...
| 3 | 機器接続 | 実機接続成功（2026-09-17）。誤トークン/誤ホスト試験、hibernate 後の再取得、TLS 時間と RAM 実測が残り |
| 4 | 即時操作 | 実装・統合テスト・デプロイ済み（2026-09-17）。実機で 202 → ir_sent の確認待ち |
| 5 | 障害系 | 未着手 |
| 6 | iOS | 未着手 |
| 7 | 予約 | 未着手 |
| 8 | 設置 | 未着手 |
