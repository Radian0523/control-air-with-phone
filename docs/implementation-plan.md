...
状態: 段階2 進行中（エアコン反応確認済み。電気試験と設置位置からの到達確認が残り）
...
| 2b | 回路組立と電気試験 | 回路組立済み・実機反応確認（2026-09-17）。§8.3 の電圧・電流測定は未実施 |
| 2c | シリアル試験スケッチ | 実機でエアコン反応確認（2026-09-17）。5ベクトル全件と設置位置からの到達確認が残り |
| 3 | 機器接続 | 未着手 |
| 4 | 即時操作 | 未着手 |
| 5 | 障害系 | 未着手 |
| 6 | iOS | 未着手 |
